-- phpMyAdmin / HostForge SAFE import (no DELIMITER/triggers).
-- Import into your EXISTING app database (sms2_db or hf_db_*). Do NOT create crad_db.
-- Full dump with triggers: ../sms2_db.sql (use mysql CLI if needed).
...
-- [trigger omitted for phpMyAdmin import]
